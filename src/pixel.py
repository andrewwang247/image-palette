...
class Pixels:
    ...
    def __init__(self, fpath: Path) -> None:
        ...
        self.img.thumbnail(_MAX_DIM, Image.Resampling.LANCZOS)
    ...
    def as_ok_lab(self) -> FloatGrid:
        ...
        img_arr = np.array(self.img.convert("RGB")) / _SRGB_SCALING
    ...
    def to_rgb(lab_arr: FloatGrid) -> IntGrid:
        ...
        return np.round(_SRGB_SCALING * rgb_arr).astype(np.int_)
